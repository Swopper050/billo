...
export BILLO_SECRET_KEY=...
export BILLO_FERNET_SECRET_KEY=...
export BILLO_DB_USER=...
export BILLO_DB_PASSWORD=...
export BILLO_MAIL_SERVER=...
export BILLO_MAIL_USERNAME=...
export BILLO_MAIL_PASSWORD=...
export BILLO_MAIL_DEFAULT_SENDER=...
...
kustomize edit set image <dockerhub-namespace>/billo-api=<dockerhub-namespace>/billo-api:<tag>
kustomize edit set image <dockerhub-namespace>/billo-tasks=<dockerhub-namespace>/billo-tasks:<tag>
kustomize edit set image <dockerhub-namespace>/billo-ui=<dockerhub-namespace>/billo-ui:<tag>
...
```bash
kubectl exec deploy/billo-api -n billo-prod -- make db_upgrade
# or for staging:
kubectl exec deploy/billo-api -n billo-staging -- make db_upgrade
```
