...
BILLO_DB_PASSWORD = os.environ.get(
    "BILLO_DB_PASSWORD", "billo_password"
)
...
BILLO_FRONTEND_URL = os.environ.get(
    "BILLO_FRONTEND_URL", "http://localhost:5173"
)
...
BILLO_MINIO_BUCKET = os.environ.get(
    "BILLO_MINIO_BUCKET", "billo-dev"
)
BILLO_MINIO_SECURE = (
    os.environ.get("BILLO_MINIO_SECURE", "False") == "True"
)
...
BILLO_STORAGE_DEFAULT_QUOTA_BYTES = int(
    os.environ.get(
        "BILLO_STORAGE_DEFAULT_QUOTA_BYTES", str(10 * 1024 * 1024 * 1024)
    )
)
...
class BaseConfig:
    ...
    MAIL_DEFAULT_SENDER = os.environ.get(
        "BILLO_MAIL_DEFAULT_SENDER", "billo@mail.com"
    )
